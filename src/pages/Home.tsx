              ...
              <div className="prose prose-lg text-slate-600">
                ...
                <div className="flex items-center gap-4 mt-8">
                  <div className="w-16 h-16 rounded-full bg-slate-200 overflow-hidden">
                    <img src={settings?.fotoKepalaSekolah || "https://drive.google.com/file/d/1OwXmgiCg1XYbPXsbHE2z5C9T4m3yXlsC/view?usp=sharing"} alt="Kepala Sekolah" className="w-full h-full object-cover" />
                  </div>
                  <div>
